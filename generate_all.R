...
render(here("rmd/Overlapping_IOTC_WCPFC.Rmd"), output_format = rdocx_document(reference_docx = paste0(here("templates/doc_template2.docx"))), output_file = paste0(here("outputs/GTA_overlaps_IOTC_WCPFC.docx")))
render(here("rmd/Overlapping_IATTC_WCPFC.Rmd"), output_format = rdocx_document(reference_docx = paste0(here("templates/doc_template2.docx"))), output_file = paste0(here("outputs/GTA_overlaps_IATTC_WCPFC.docx")))
