...
The only specie for which IATTC have higher records is SWO but it would be to complicated to make a choice for every species. Moreover, the data is not this different for the two tRFMOs, still it has to be noted that it is not homogeneously reported geographically. 
