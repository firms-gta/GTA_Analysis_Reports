...
What can be learned from those plots is that the captures are similar on the overlapping zone for the two tRFMOs. What we recommend is to keep data from IOTC as there are less captures UNK and for which we have conversion factors provided that allows us to create a Global Tuna Atlas level 1. 
